...
public class updateTest extends BaseConfig {
	...
	public void update() throws Exception{
		...
		RoleInfo update_roleInfo = new RoleInfo();
		update_roleInfo.setName("test02");
		update_roleInfo.setPrivilege(new Integer[]{1,2,4,5,6});
		roleInfoManager.update(id, update_roleInfo);
		testManager.flush();
