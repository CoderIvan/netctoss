...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <s:form action="addRole_save" method="post" cssClass="main_form" namespace="/role" theme="simple">
                <div class="text_info clearfix">
                	<span>角色名称：</span>
                </div>
                <div class="input_info">
                    <s:textfield cssClass="width200" name="roleName" id="roleName"/>
